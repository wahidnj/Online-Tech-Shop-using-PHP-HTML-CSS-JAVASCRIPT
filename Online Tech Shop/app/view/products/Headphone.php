...
include_once (PROJECT_ROOT_PATH ."/../../../core/products/headphone_service.php");
    ...
    $headphoneList=loadAllHeadphone();
  ...
  <tr>
               ...
               <div id="container">
                ...
                <div id='t'>
                    ...
                    <p><b>$headphone[BRAND]</b></p>
                    
                    <p><b>$headphone[HID]</b></p>
                     <p>Price: <b>$headphone[S_PRICE]</b></p>
                    </div>
                    <div id='p'>
                    ...
                    <div id='b'>
                     <a href='Product_Details.php?invoice=$headphone[HINVOICE]'> <button>Buy</button></a>
