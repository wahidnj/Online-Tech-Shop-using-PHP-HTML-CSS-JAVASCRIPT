...
include_once (PROJECT_ROOT_PATH ."/../../../core/products/pendrive_service.php");

    $pendriveList=loadAllPendrive();
...
<table width=90% align="center" >
  <tr>
               ...
               <div id="container">
                ...
                foreach ($pendriveList as $pendrive) {
                ...
                <div id='t'>
                    ...
                    <p><b>$pendrive[BRAND]</b></p>
                    
                    <p><b>$pendrive[PEID]</b></p>
                     <p>Price: <b>$pendrive[S_PRICE]</b></p>
                    </div>
                    <div id='p'>
                    ...
                    <div id='b'>
                     <a href='Product_Details.php?invoice=$pendrive[PEINVOICE]'> <button>Buy</button></a>
