...
include_once (PROJECT_ROOT_PATH ."/../../../core/products/product_service.php");
    ...
    echo "<br/>";
         ...
         echo "
            <form  method='POST' action='confirmUpdate.php?invoice=$product[PINVOICE]'>
            <div style='background-color:white' align='center' >
            <fieldset style='width:500px' >
            
            <legend align='center'><h3>Update Product</h3></legend>
            
            Quantity: <input type='text' name='quantity'><br><br>
            Sell Price: <input type='text' name='sell_Price'><br><br>
            <a  href='confirmUpdate.php?invoice=$product[PINVOICE]''><button type='submit' name='update' value='update' >Update</button></a>
